...
class AppointmentDetailCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    OrderSummary? summary = OrderSummary.fromJson(jsonDecode(data?.orderSummary ?? ''));
    return Container(
          ...
          AnimatedExpansion(
            ...
            child: Column(
              children: [
                ...
                _paymentFiled(title: S.current.consultationCharge, amount: summary.serviceAmount ?? 0),
                const SizedBox(
                  height: 3,
                ),
                ...
                /// Taxable Amount
                _paymentFiled(title: S.current.subTotal, amount: summary.subtotal ?? 0, color: ColorRes.softPeach),
                const SizedBox(
                  height: 3,
                ),
                ...
                /// payable amount
                _paymentFiled(title: S.current.payableAmount, amount: summary.payableAmount ?? 0),
                const SizedBox(
                  height: 20,
                ),
              ],
      ...
      child: Column(
        ...
        children: [
          ...
          Visibility(
            ...
            child: FittedBox(
              child: Container(
                decoration: BoxDecoration(color: ColorRes.dawnPink, borderRadius: BorderRadius.circular(6)),
                child: Row(
                  children: [
                    Container(
                      height: 30,
                      ...
                      child: Text(
                        ...
                        style: const TextStyle(color: ColorRes.tuftsBlue, fontFamily: FontRes.bold, fontSize: 13),
                      ),
                    ),
                  ],
                ),
...
class AppointmentCardFiled extends StatelessWidget {
  ...
  const AppointmentCardFiled({Key? key, required this.title, required this.desc}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Text(
          desc,
          style: const TextStyle(fontSize: 16, color: ColorRes.tuftsBlue, fontFamily: FontRes.semiBold),
        ),
      ],
    );
  }
