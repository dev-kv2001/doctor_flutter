            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  ListTiles(
                      onTap: () {
                        Get.to(() => const SelectCategoryScreen(screenType: 1));
                      },
                      title: S.of(context).myCategory),
                  ListTiles(
                      onTap: () {
                        Get.to(() => const DoctorProfileScreenTwo(), arguments: S.current.aboutYourselfEducation);
                      },
                      title: S.current.aboutYourselfEducation),
                  ListTiles(
                      onTap: () {
                        Get.to(() => const DoctorProfileScreenThree(), arguments: S.current.consultationType);
                      },
