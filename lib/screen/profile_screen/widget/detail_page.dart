      ...
      child: Column(
        ...
        children: [
          ServiceHeading(
            ...
            isManageVisible: controller.doctorData.value?.services == null || controller.doctorData.value!.services!.isEmpty ? false : true,
          ),
          controller.doctorData.value?.services == null || controller.doctorData.value!.services!.isEmpty
              ? NoDataCard(
              ...
              : ServiceText(
                  itemCount: !controller.isShowMore && (controller.doctorData.value?.services?.length ?? 0) > 4
                      ? 4
          ...
          Visibility(
            visible: (controller.doctorData.value?.services?.length ?? 0) > 4 ? true : false,
            child: Container(
              ...
              child: InkWell(
                ...
                child: Text(
                  controller.isShowMore ? S.current.less : "+${(controller.doctorData.value?.services?.length ?? 0) - 4} ${S.current.more}",
                  style: const TextStyle(fontFamily: FontRes.semiBold, fontSize: 15, color: ColorRes.havelockBlue),
                ),
              ),
            ),
          ),
      ...
      child: Column(
        ...
        children: [
          ServiceHeading(
            ...
            isManageVisible: controller.doctorData.value?.expertise == null || controller.doctorData.value!.expertise!.isEmpty ? false : true,
          ),
          controller.doctorData.value?.expertise == null || controller.doctorData.value!.expertise!.isEmpty
              ? NoDataCard(
              ...
              : ServiceText(
                  itemCount: !controller.isShowMore && (controller.doctorData.value?.expertise?.length ?? 0) > 4
                      ? 4
          ...
          Visibility(
            visible: (controller.doctorData.value?.expertise?.length ?? 0) > 4 ? true : false,
            child: Container(
              padding: const EdgeInsets.symmetric(horizontal: 10),
              child: InkWell(
                onTap: () {
                ...
                child: Text(
                  controller.isShowMore ? S.current.less : "+${(controller.doctorData.value?.expertise?.length ?? 0) - 4} ${S.current.more}",
                  style: const TextStyle(fontFamily: FontRes.semiBold, fontSize: 15, color: ColorRes.havelockBlue),
                ),
              ),
            ),
...
class ServiceLocation extends StatelessWidget {
      ...
      child: Column(
        ...
        children: [
          ServiceHeading(
            ...
            isManageVisible:
                controller.doctorData.value?.serviceLocations == null || controller.doctorData.value!.serviceLocations!.isEmpty ? false : true,
          ),
  ...
  Widget _serviceLocationCard() {
    return controller.doctorData.value?.serviceLocations == null || controller.doctorData.value!.serviceLocations!.isEmpty
        ? NoDataCard(
        ...
        : ListView.builder(
            ...
            itemBuilder: (context, index) {
              ServiceLocations? serviceLocations = controller.doctorData.value!.serviceLocations?[index];
              return InkWell(
                onTap: () {
                  Get.to(
                    () => AddServiceLocation(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        children: [
                          Expanded(
                            child: Text(
                              ...
                              style:
                                  const TextStyle(fontSize: 15, fontFamily: FontRes.bold, color: ColorRes.davyGrey, overflow: TextOverflow.ellipsis),
                            ),
                          ),
                          Icon(
                            Directionality.of(context) == TextDirection.rtl ? Icons.keyboard_arrow_left_rounded : Icons.keyboard_arrow_right_rounded,
                      ...
                      Text(
                        serviceLocations?.hospitalAddress ?? S.current.noAddressFound,
