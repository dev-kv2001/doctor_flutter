...
class ReviewPage extends StatelessWidget {
  ...
  const ReviewPage({Key? key, this.controller}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    DoctorData? doctorData = controller?.doctorData.value;
    return (controller?.reviewData ?? []).isEmpty
        ? CustomUi.noDataImage(message: S.of(context).noReview)
        : Column(
            children: [
              Container(
              ...
              ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ReviewData? data = controller?.reviewData[index];
                  return Container(
