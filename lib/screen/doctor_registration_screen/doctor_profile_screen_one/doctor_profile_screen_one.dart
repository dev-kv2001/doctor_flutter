                                ...
                                builder: (_) {
                                  return Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          controller.userData?.name ?? S.current.unKnown,
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            Expanded(
                                              child: Text(
                                                controller.designationController.text.isNotEmpty
                                                    ? controller.designationController.text
                                                    : controller.userData?.designation ?? S.current.addYourDesignation,
                                                style: const TextStyle(
                                        ...
                                        Text(
                                          controller.degreeController.text.isNotEmpty
                                              ? controller.degreeController.text
                                              : controller.userData?.degrees ?? S.current.addYourDegreesEtc,
                                          style: const TextStyle(fontSize: 14.5, color: ColorRes.mediumGrey),
                                        ),
                                      ],
                                    ),
                                  );
