...
class S {
  ...
  /// `Wrong password you enter`
  String get wrongPasswordYouEnter {
    return Intl.message(
      'Wrong password you enter',
      name: 'wrongPasswordYouEnter',
      desc: '',
      args: [],
    );
  }
  ...
  String get manageYourAppointmentsWithPrecisionTransformingTheWayYouConnect {
    return Intl.message(
      'Manage your appointments with\nprecision, transforming the way you\nconnect with your patients.',
      name: 'manageYourAppointmentsWithPrecisionTransformingTheWayYouConnect',
      desc: '',
      args: [],
    );
  }
  ...
  String get verifyTheLinkSentToYourEmailThenCompleteThe {
    return Intl.message(
      'Verify the link sent to your email, then complete the form.',
      name: 'verifyTheLinkSentToYourEmailThenCompleteThe',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Enter Caption here`
  String get enterCaptionHere {
    return Intl.message(
      'Enter Caption here',
      name: 'enterCaptionHere',
      desc: '',
      args: [],
    );
  }
  ...
  String get theEmailIsAlreadyInUseInThe {
    return Intl.message(
      'The email is already in use in the',
      name: 'theEmailIsAlreadyInUseInThe',
      desc: '',
      args: [],
    );
  }
  ...
  String get pleaseUseADifferentEmailAddress {
    return Intl.message(
      'Please use a different email address.',
      name: 'pleaseUseADifferentEmailAddress',
      desc: '',
      args: [],
    );
  }
  ...
  String get deletePostPermanently {
    return Intl.message(
      'Delete Post Permanently?',
      name: 'deletePostPermanently',
      desc: '',
      args: [],
    );
  }
  ...
  String get areYouSureYouWantToDeleteThisPostThis {
    return Intl.message(
      'Are you sure you want to delete this post? This action cannot be undone, and the post will be permanently removed.',
      name: 'areYouSureYouWantToDeleteThisPostThis',
      desc: '',
      args: [],
    );
  }
  ...
  String get pleaseExplainTheIssueBrieflyWeWillSurelyNotifyThis {
    return Intl.message(
      'Please explain the issue briefly. We will surely notify this to admin.',
      name: 'pleaseExplainTheIssueBrieflyWeWillSurelyNotifyThis',
      desc: '',
      args: [],
    );
  }
  ...
  String get pleaseExplainYourReasonBriefly {
    return Intl.message(
      'Please explain your reason briefly.',
      name: 'pleaseExplainYourReasonBriefly',
      desc: '',
      args: [],
    );
  }
  ...
  String get areYouSureYouWantToDeclineThisAppointmentThis {
    return Intl.message(
      'Are you sure you want to decline this appointment? This action cannot be undone.',
      name: 'areYouSureYouWantToDeclineThisAppointmentThis',
      desc: '',
      args: [],
    );
  }
  ...
  String get deleteAppointmentSlot {
    return Intl.message(
      'Delete Appointment Slot',
      name: 'deleteAppointmentSlot',
      desc: '',
      args: [],
    );
  }
  ...
  String get areYouSureYouWantToDeleteThisAppointmentSlot {
    return Intl.message(
      'Are you sure you want to delete this appointment slot? You can add a new slot later if needed.',
      name: 'areYouSureYouWantToDeleteThisAppointmentSlot',
      desc: '',
      args: [],
    );
  }
  ...
  String get areYouSureYouWantToDeleteThisChatAll {
    return Intl.message(
      'Are you sure you want to delete this chat? All chat data will be permanently removed and cannot be restored.',
      name: 'areYouSureYouWantToDeleteThisChatAll',
      desc: '',
      args: [],
    );
  }
  ...
  String get areYouSureYouWantToDeleteThisMessageOnce {
    return Intl.message(
      'Are you sure you want to delete this message? Once deleted, it cannot be recovered.',
      name: 'areYouSureYouWantToDeleteThisMessageOnce',
      desc: '',
      args: [],
    );
  }
  ...
  String get areYouSureYouWantToLeaveTheVideoMeeting {
    return Intl.message(
      'Are you sure you want to leave the video meeting? You will exit the meeting and will no longer be able to participate.',
      name: 'areYouSureYouWantToLeaveTheVideoMeeting',
      desc: '',
      args: [],
    );
  }
  ...
  String get fillInYourDetailsToStartYourDigitalPracticeConnect {
    return Intl.message(
      'Fill in your details to start your digital practice. Connect with patients and manage appointments effortlessly.',
      name: 'fillInYourDetailsToStartYourDigitalPracticeConnect',
      desc: '',
      args: [],
    );
  }
